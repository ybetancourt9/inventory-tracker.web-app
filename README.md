...
Built for the SNHU CS 499 capstone. The [ePortfolio](https://ybetancourt9.github.io/inventory-tracker.web-app/) covers the three enhancements, the reasoning behind them, and the self-assessment.
